...
$.fn.jqGrid = function( pin ) {
	...
	return this.each( function() {
		...
		setPager = function (pgid, tp){
			...
			$("#"+$.jgrid.jqID(pgid) )
			.append("<div id='" + pgcnt + "' class='ui-pager-control' role='group'><table cellspacing='0' cellpadding='0' border='0' class='ui-pg-table' style='width:100%;table-layout:fixed;height:100%;' role='row'><tbody><tr><td id='" + cent + "' align='left' style='white-space:pre;'></td><td id='" + lft + "' align='center'></td><td id='" + rgt + "' align='right'></td></tr></tbody></table></div>")
			...
			if(ts.p.pgbuttons===true) {
				...
				pgl += "<td id='"+po[1]+"' class='ui-pg-button ui-corner-all'><span class=''>上一页</span></td>";
				pgl += pginp !== "" ? sep+pginp+sep:"";
				pgl += "<td id='"+po[2]+"' class='ui-pg-button ui-corner-all'><span class=''>下一页</span></td>";
		...
		for(i=0;i<this.p.colNames.length;i++){
			...
			thead += "<div id='jqgh_" + ts.p.id + "_" + ts.p.colModel[i].name + "' " + tdc + ">" + "<span style='font-weight:normal;'>" + ts.p.colNames[i] + "</span>";
