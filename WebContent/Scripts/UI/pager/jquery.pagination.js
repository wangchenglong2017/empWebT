        ...
        function drawLinks() {
            ...
            var appendItem = function (page_id, appendopts) {
                ...
                if (page_id == current_page) {
                    if (!isNaN(appendopts.text)) {
                        ...
                        var lnk = jQuery("<span class='spancolor'>" + (appendopts.text) + "</span>");
                    }
                }
                else {
            ...
            if (interval[0] > 0 && opts.num_edge_entries > 0) {
                ...
                if (opts.num_edge_entries < interval[0] && opts.ellipse_text) {
                    ...
                    panel.find("[id='pagerrigt']").append("<span style='padding-right:3px'>" + opts.ellipse_text + "</span>");
                }
            }
            ...
            if (interval[1] < np && opts.num_edge_entries > 0) {
                if (np - opts.num_edge_entries > interval[1] && opts.ellipse_text) {
                    //jQuery("<span>" + opts.ellipse_text + "</span>").appendTo(panel[0]);
                    panel.find("[id='pagerrigt']").append("<span style='padding-right:4px'>" + opts.ellipse_text + "</span>");
                }
            ...
            if (opts.next_text && (current_page < np - 1 || opts.next_show_always)) {
                appendItem(current_page + 1, { text: opts.next_text, classes: "" }); //  appendItem(current_page + 1, { text: opts.next_text, classes: "next" });
            }
            // Generate "Last"-Link
            if (opts.last_text
