...
(function ($) {
    ...
    function _1df(_1e0) {
        ...
        if (_1e1.options.top == null) {
            ...
            if (_1e1.options.inline) {
                var _1e6 = _1e1.window.parent();
                _1e1.options.top = (_1e6.height() - _1e7) / 2 + _1e6.scrollTop();//parent.$.messager.dialog 弹出窗的位置  jxj
            } else {
                _1e1.options.top = ($(window).height() - _1e7) / 2 + $(document).scrollTop();//parent.$.messager.confirm 弹出窗的位置 jxj
            }
        }
        _1db(_1e0);
...
(function ($) {
    ...
    $.messager = { show: function (_216) {
        ...
        var _21b = "<div class=\"messager-icon messager-question\"></div>" + "<div class=\"delete\">" + msg + "</div>" + "<div style=\"clear:both;\"/>";
        var _21c = {};
...
(function ($) {
    ...
    }, length: { validator: function (_38d, _38e) {
        var len = $.trim(_38d).length;
        return len >= _38e[0] && len <= _38e[1];
    }, message: "Please enter a value between {0} and {1}."
    }, remote: { validator: function (_38f, _390) {
        var data = {};
        data[_390[1]] = _38f;
